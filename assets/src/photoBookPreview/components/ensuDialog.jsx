...
class EnsuDialog extends React.Component{
  constructor(props){
    super(props);
  }
  ...
  render(){
    return (
      <div className="weui_dialog_confirm tf_wx_dialog different" id="cart_dialog" style={{fontSize:'0.24rem'}}>
        <div className="weui_mask different" style={{zIndex:40}}></div>
        <div className="weui_dialog different" style={{width:'85%'}}>
          ...
          <div className="weui_dialog_ft different">
            <a href="javascript:;" className="weui_btn weui_btn_dialog weui-btn_default different" onClick={this.handCancel.bind(this)}>继续浏览</a>
