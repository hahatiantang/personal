    ...
    return (
      <div className="weui_dialog_confirm tf_wx_dialog" id="ecit_text_dialog" style={{fontSize:'0.24rem'}}>
        ...
        <div className="weui_dialog" style={{width:'85%'}}>
          <div className="weui_dialog_hd"><strong className="weui_dialog_title">编辑</strong><img onClick={() => this.props.closeTextDialog()} style={closeBtnStyle} src={closeBtn} /></div>
          <div className="weui_dialog_bd">
            <div className="weui-cells weui-cells_form">
              <div className="weui-cell">
                <div className="weui-cell__bd" style={{textAlign:'center'}}>
                  <textarea style={{width:'90%',height:'2rem'}} className="weui-textarea" placeholder="请输入文本" rows="3"
          ...
          <div className="weui_dialog_ft" style={{height:'1rem','marginTop':'0.2rem'}}>
